...
//@interface k1508_InfoApp_Fawcett_KeithObject : NSObject
//@end

@interface k1508_InfoApp_Fawcett_KeithObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k1508_InfoApp_Fawcett_KeithObject class]])
		{
			for (NSString *key in [[(k1508_InfoApp_Fawcett_KeithObject*)o modules] allKeys])
			{
