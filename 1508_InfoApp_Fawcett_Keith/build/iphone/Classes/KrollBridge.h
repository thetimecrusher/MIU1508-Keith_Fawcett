...
@interface k1508_InfoApp_Fawcett_KeithObject : KrollCoverageObject {
#else
@interface k1508_InfoApp_Fawcett_KeithObject : KrollObject {
#endif
@private
...
extern NSString * k1508_InfoApp_Fawcett_Keith$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k1508_InfoApp_Fawcett_KeithObject *_k1508_infoapp_fawcett_keith;
    KrollObject* console;
	BOOL shutdown;
