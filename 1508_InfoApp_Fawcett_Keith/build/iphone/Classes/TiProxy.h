...
//Rare exceptions to indicate a bug in the _k1508_infoapp_fawcett_keith code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k1508_InfoApp_Fawcett_Keith proxies.
 */
