...
/**
 The base class for all fawcett_keith_project1 modules
 */
...
/**
 fawcett_keith_project1 Platform calls this method on startup.
 */
-(void)startup;

/**
 fawcett_keith_project1 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 fawcett_keith_project1 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 fawcett_keith_project1 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 fawcett_keith_project1 Platform calls this method on resume.
 @param sender The sender of the event.
 */
