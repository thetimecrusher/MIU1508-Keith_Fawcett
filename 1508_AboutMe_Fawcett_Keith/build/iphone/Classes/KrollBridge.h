...
@interface fawcett_keith_project1Object : KrollCoverageObject {
#else
@interface fawcett_keith_project1Object : KrollObject {
#endif
@private
...
extern NSString * fawcett_keith_project1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	fawcett_keith_project1Object *_fawcett_keith_project1;
    KrollObject* console;
	BOOL shutdown;
