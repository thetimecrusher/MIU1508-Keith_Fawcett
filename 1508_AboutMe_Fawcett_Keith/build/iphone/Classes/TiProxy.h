...
//Rare exceptions to indicate a bug in the _fawcett_keith_project1 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for fawcett_keith_project1 proxies.
 */
