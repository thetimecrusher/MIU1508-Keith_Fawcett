...
// in simulator we redefine to format for fawcett_keith_project1 Developer console
...
{\
	NSString * exceptionName = [@"org.fawcett_keith_project1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.fawcett_keith_project1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIfawcett_keith_project1NativeItemNone = -1, 
	UIfawcett_keith_project1NativeItemSpinner = -2,
	UIfawcett_keith_project1NativeItemProgressBar = -3,
	
	UIfawcett_keith_project1NativeItemSlider = -4,
	UIfawcett_keith_project1NativeItemSwitch = -5,
	UIfawcett_keith_project1NativeItemMultiButton = -6,
	UIfawcett_keith_project1NativeItemSegmented = -7,
	
	UIfawcett_keith_project1NativeItemTextView = -8,
	UIfawcett_keith_project1NativeItemTextField = -9,
	UIfawcett_keith_project1NativeItemSearchBar = -10,
	
	UIfawcett_keith_project1NativeItemPicker = -11,
	UIfawcett_keith_project1NativeItemDatePicker = -12,
	
	UIfawcett_keith_project1NativeItemInfoLight = -13,
	UIfawcett_keith_project1NativeItemInfoDark = -14,
	
	UIfawcett_keith_project1NativeItemDisclosure = -15,
	
	UIfawcett_keith_project1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all fawcett_keith_project1 instances of
