 ...
 * to send analytic data that can be viewed on the fawcett_keith_project1 Dashboard.
 *
 * For information on getting started with fawcett_keith_project1 Platform Services,
