...
//@interface fawcett_keith_project1Object : NSObject
//@end

@interface fawcett_keith_project1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[fawcett_keith_project1Object class]])
		{
			for (NSString *key in [[(fawcett_keith_project1Object*)o modules] allKeys])
			{
