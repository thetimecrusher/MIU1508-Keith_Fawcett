...
// in simulator we redefine to format for k1508_UtilityApp_Fawcett_Keith Developer console
...
{\
	NSString * exceptionName = [@"org.k1508_utilityapp_fawcett_keith." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k1508_utilityapp_fawcett_keith";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk1508_UtilityApp_Fawcett_KeithNativeItemNone = -1, 
	UIk1508_UtilityApp_Fawcett_KeithNativeItemSpinner = -2,
	UIk1508_UtilityApp_Fawcett_KeithNativeItemProgressBar = -3,
	
	UIk1508_UtilityApp_Fawcett_KeithNativeItemSlider = -4,
	UIk1508_UtilityApp_Fawcett_KeithNativeItemSwitch = -5,
	UIk1508_UtilityApp_Fawcett_KeithNativeItemMultiButton = -6,
	UIk1508_UtilityApp_Fawcett_KeithNativeItemSegmented = -7,
	
	UIk1508_UtilityApp_Fawcett_KeithNativeItemTextView = -8,
	UIk1508_UtilityApp_Fawcett_KeithNativeItemTextField = -9,
	UIk1508_UtilityApp_Fawcett_KeithNativeItemSearchBar = -10,
	
	UIk1508_UtilityApp_Fawcett_KeithNativeItemPicker = -11,
	UIk1508_UtilityApp_Fawcett_KeithNativeItemDatePicker = -12,
	
	UIk1508_UtilityApp_Fawcett_KeithNativeItemInfoLight = -13,
	UIk1508_UtilityApp_Fawcett_KeithNativeItemInfoDark = -14,
	
	UIk1508_UtilityApp_Fawcett_KeithNativeItemDisclosure = -15,
	
	UIk1508_UtilityApp_Fawcett_KeithNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all k1508_UtilityApp_Fawcett_Keith instances of
