...
/**
 Base class for all k1508_UtilityApp_Fawcett_Keith views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the k1508_UtilityApp_Fawcett_Keith view hierarchy (such as wrapped iOS UIViews) was touched.
