...
//Rare exceptions to indicate a bug in the _k1508_utilityapp_fawcett_keith code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k1508_UtilityApp_Fawcett_Keith proxies.
 */
