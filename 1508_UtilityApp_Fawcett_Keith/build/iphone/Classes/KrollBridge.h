...
@interface k1508_UtilityApp_Fawcett_KeithObject : KrollCoverageObject {
#else
@interface k1508_UtilityApp_Fawcett_KeithObject : KrollObject {
#endif
@private
...
extern NSString * k1508_UtilityApp_Fawcett_Keith$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k1508_UtilityApp_Fawcett_KeithObject *_k1508_utilityapp_fawcett_keith;
    KrollObject* console;
	BOOL shutdown;
