...
var aboutMe = {
	...
	"rows":[
		...
		"Answer": "My chat host is AIM and my user name is kafawcett@fullsail.edu."},
		...
		{"Title" : "Comfort with Appcelerator?",
		"Question":"How comfortable are you with Appcelerator?",
		"Answer": "I am a little rusty but pretty comfortable with Appcelerator."},
